...
//                    Point.fromLngLat(25.4358, 81.8463), // coffee shop
//                    Point.fromLngLat(22.5726, 88.3639) // airport
                Point.fromLngLat(81.8463, 25.4358), // coffee shop
                    Point.fromLngLat(88.3639, 22.5726) // airport
...
//    latLngAnimator.setDuration((long) TurfMeasurement.distance(currentPosition, targetPosition, "meters"));
        latLngAnimator.setDuration((long)0);
          ...
          mapboxMap.easeCamera(CameraUpdateFactory.newLatLngBounds(
              new LatLngBounds.Builder()
                  .include(new LatLng(origin.latitude(), origin.longitude()))
                      .include(new LatLng(12.972442, 77.580643)) //Bangalore
                      .include(new LatLng(26.922070, 75.778885)) //Jaipur
                      .include(new LatLng(8.088306, 77.538452)) //kanyakumari
                      .include(new LatLng(42.882004	, 74.582748)) //kanyakumari
